...
int melodiaSirena[] = {		// array con las notas de la melodia
  //Sirena
  NOTE_C4, NOTE_G3, NOTE_C4, NOTE_G3, NOTE_C4, NOTE_G3, NOTE_C4, NOTE_G3
};

int melodiaBLoqueado[] = {		// array con las notas de la melodia
  //Sistema bloqueado
  NOTE_C4, NOTE_G3, NOTE_E3, NOTE_A3, NOTE_B3, NOTE_A3, NOTE_AS3, NOTE_A3
};
...
void setupBuzzer() {
  ...
  TaskEjecutarBuzzer.Start();
}

void playMelody(int melodia[], int duraciones[], int longitud) {
...
void playCurrentMelody(){
  switch (currentMelody){
    case 1:
      playMelody(melodiaSirena, duracionesSirena, 8);
      break;
    case 2:
      playMelody(melodiaBLoqueado, duracionesBloqueado, 8);
      break;
  }
}
